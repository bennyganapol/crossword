  ...
  return (
    <div
      ...
      style={Object.assign(
        ...
        props.isQuestionSquare || !props.answerLetter
          ? styles.questionSqaure
          : null,
        props.selected ? styles.selectedSquare : null,
        props.challenges &&
          props.challenges.length >= 2 &&
          props.isQuestionSquare
          ? styles.splittedSquare
          : null,
      )}
    >
      {props.image && (
      ...
      {getQuestion()}
      <span style={{}}>{props.currentLetter}</span>
    </div>
  );
}
